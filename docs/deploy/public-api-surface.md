...
- Real-channel readiness may expose configured channel names, allowlisted channel names, and allowlisted pair counts, but must never expose tenant IDs, webhook secrets, signatures, or raw request bodies.
