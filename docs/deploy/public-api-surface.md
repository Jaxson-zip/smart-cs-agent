...
| `GET /v2/integrations` | Legacy operator API | Operator key required; returns Provider adapter contracts with `adapterMode`, `writePolicy`, `customerVisibleActionsEnabled`, `realCommerceActionsEnabled`, `contractVersion`, and `safetyNotes` |
