...
- `evidence`: preflight verifier, provider write approval verifier, kill-switch control plane, audit export, post-pilot review, and production launch verifier pass booleans.
- `artifactBindings`: SHA-256 bindings for preflight, provider write approval, kill-switch control plane, live executor startup guard, live executor control plane, production launch, and audit export artifacts.
