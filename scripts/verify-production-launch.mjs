...
const files = {
  ...
  providerWriteControlledExpansionPreflight:
    "docs/deploy/provider-write-controlled-expansion-preflight.md",
  ...
  providerWriteControlledExpansionPreflightVerifier:
    "scripts/verify-provider-write-controlled-expansion-preflight.mjs",
  providerWriteControlledExpansionRunLedgerVerifier:
...
mustContainAll("production readiness references provider write controlled expansion preflight", content.productionReadiness, [
...
mustContainAll("production readiness references provider write controlled expansion run ledger", content.productionReadiness, [
...
mustContainAll("production readiness references provider write controlled expansion closeout review", content.productionReadiness, [
...
mustContainAll("production readiness references provider write graduated rollout preflight", content.productionReadiness, [
...
mustContainAll("production readiness references provider write graduated rollout closeout review", content.productionReadiness, [
...
mustContainAll("task plan references PR76", content.taskPlan, [
  "PR76 - Provider Write Controlled Expansion Closeout Review Gate",
  "verify:provider-write-controlled-expansion-closeout-review",
]);
...
mustContainAll("provider write controlled expansion preflight verifier source", content.providerWriteControlledExpansionPreflightVerifier, [
  "verify:provider-write-controlled-expansion-preflight",
  ...
  "validateApprovalSafeLedgerAssemblyBinding",
...
mustContainAll("provider write controlled expansion run ledger verifier source", content.providerWriteControlledExpansionRunLedgerVerifier, [
  "verify:provider-write-controlled-expansion-run-ledger",
  ...
  "providerWriteControlledExpansionPreflightSha256",
  "validateRunLedgerPreflightBinding",
  "validateRunLedgerWithinPreflight",
...
mustContainAll("provider write controlled expansion closeout review verifier source", content.providerWriteControlledExpansionCloseoutReviewVerifier, [
  "verify:provider-write-controlled-expansion-closeout-review",
  ...
  "controlled_multi_merchant",
  "providerWriteControlledExpansionRunLedgerSha256",
  "validateReviewRunLedgerBinding",
  "approved_for_next_expansion_review",
  "customerComplaintsStoppedRollout",
  "rejectedCompensationReviewed",
...
mustContainAll("provider write graduated rollout preflight verifier source", content.providerWriteGraduatedRolloutPreflightVerifier, [
  "verify:provider-write-graduated-rollout-preflight",
  ...
  "rollbackOnAnyFailedMutation",
  "noAutomaticCustomerVisibleReplies",
  "validatePreflightApprovalBinding",
...
mustContainAll("provider write graduated rollout closeout review verifier source", content.providerWriteGraduatedRolloutCloseoutReviewVerifier, [
  "verify:provider-write-graduated-rollout-closeout-review",
...
mustContainAll("provider write controlled expansion preflight docs", content.providerWriteControlledExpansionPreflight, [
  "PR74 Provider Write Controlled Expansion Preflight Gate",
  "npm run verify:provider-write-controlled-expansion-preflight",
  "npm run verify:provider-write-controlled-expansion-preflight:safe",
  "SMARTCS_PROVIDER_WRITE_CONTROLLED_EXPANSION_PREFLIGHT_FILE",
...
mustContainAll("provider write controlled expansion run ledger docs", content.providerWriteControlledExpansionRunLedger, [
  "PR75 Provider Write Controlled Expansion Run Ledger Gate",
  "npm run verify:provider-write-controlled-expansion-run-ledger",
  "npm run verify:provider-write-controlled-expansion-run-ledger:safe",
  "SMARTCS_PROVIDER_WRITE_CONTROLLED_EXPANSION_RUN_LEDGER_FILE",
...
mustContainAll("provider write controlled expansion closeout review docs", content.providerWriteControlledExpansionCloseoutReview, [
  "PR76 Provider Write Controlled Expansion Closeout Review Gate",
  "npm run verify:provider-write-controlled-expansion-closeout-review",
  "npm run verify:provider-write-controlled-expansion-closeout-review:safe",
  "SMARTCS_PROVIDER_WRITE_CONTROLLED_EXPANSION_CLOSEOUT_REVIEW_FILE",
...
mustContainAll("provider write graduated rollout preflight docs", content.providerWriteGraduatedRolloutPreflight, [
  "PR78 Provider Write Graduated Rollout Preflight Gate",
  "npm run verify:provider-write-graduated-rollout-preflight",
  "npm run verify:provider-write-graduated-rollout-preflight:safe",
  "SMARTCS_PROVIDER_WRITE_GRADUATED_ROLLOUT_PREFLIGHT_FILE",
...
mustContainAll("provider write graduated rollout closeout review docs", content.providerWriteGraduatedRolloutCloseoutReview, [
  "PR80 Provider Write Graduated Rollout Closeout Review Gate",
  "npm run verify:provider-write-graduated-rollout-closeout-review",
  "npm run verify:provider-write-graduated-rollout-closeout-review:safe",
...
mustContainAll("provider write controlled expansion preflight docs reference", content.providerWriteRequests, [
  "PR74 Provider Write Controlled Expansion Preflight Gate",
  "npm run verify:provider-write-controlled-expansion-preflight",
  "smart-cs-agent.provider-write-controlled-expansion-preflight.v1",
  "controlled_multi_merchant",
...
mustContainAll("provider write controlled expansion run ledger docs reference", content.providerWriteRequests, [
  "PR75 Provider Write Controlled Expansion Run Ledger Gate",
  "npm run verify:provider-write-controlled-expansion-run-ledger",
  "smart-cs-agent.provider-write-controlled-expansion-run-ledger.v1",
  "controlled_multi_merchant",
...
mustContainAll("provider write controlled expansion closeout review docs reference", content.providerWriteRequests, [
  "PR76 Provider Write Controlled Expansion Closeout Review Gate",
  "npm run verify:provider-write-controlled-expansion-closeout-review",
  "smart-cs-agent.provider-write-controlled-expansion-closeout-review.v1",
  "providerWriteControlledExpansionRunLedgerSha256",
...
mustContainAll("provider write graduated rollout preflight docs reference", content.providerWriteRequests, [
  "PR78 Provider Write Graduated Rollout Preflight Gate",
  "npm run verify:provider-write-graduated-rollout-preflight",
  "smart-cs-agent.provider-write-graduated-rollout-preflight.v1",
  "providerWriteGraduatedRolloutApprovalSha256",
...
mustContainAll("provider write graduated rollout closeout review docs reference", content.providerWriteRequests, [
  "PR80 Provider Write Graduated Rollout Closeout Review Gate",
  "npm run verify:provider-write-graduated-rollout-closeout-review",
  "smart-cs-agent.provider-write-graduated-rollout-closeout-review.v1",
  "providerWriteGraduatedRolloutRunLedgerSha256",
...
mustContainAll("task plan tracks provider write controlled expansion preflight", content.taskPlan, [
  "PR74 - Provider Write Controlled Expansion Preflight Gate",
  "verify:provider-write-controlled-expansion-preflight",
]);

mustContainAll("progress tracks provider write controlled expansion preflight", content.progress, [
  "Started PR74 provider write controlled expansion preflight gate",
]);

mustContainAll("task plan tracks provider write controlled expansion run ledger", content.taskPlan, [
  "PR75 - Provider Write Controlled Expansion Run Ledger Gate",
  "verify:provider-write-controlled-expansion-run-ledger",
]);

mustContainAll("progress tracks provider write controlled expansion run ledger", content.progress, [
  "Started PR75 provider write controlled expansion run ledger gate",
]);

mustContainAll("task plan tracks provider write controlled expansion closeout review", content.taskPlan, [
  "PR76 - Provider Write Controlled Expansion Closeout Review Gate",
  "verify:provider-write-controlled-expansion-closeout-review",
]);

mustContainAll("progress tracks provider write controlled expansion closeout review", content.progress, [
...
mustContainAll("task plan tracks provider write graduated rollout preflight", content.taskPlan, [
  "PR78 - Provider Write Graduated Rollout Preflight Gate",
  "verify:provider-write-graduated-rollout-preflight",
]);

mustContainAll("progress tracks provider write graduated rollout preflight", content.progress, [
...
mustContainAll("task plan tracks provider write graduated rollout closeout review", content.taskPlan, [
  "PR80 - Provider Write Graduated Rollout Closeout Review Gate",
  "verify:provider-write-graduated-rollout-closeout-review",
]);

mustContainAll("progress tracks provider write graduated rollout closeout review", content.progress, [
